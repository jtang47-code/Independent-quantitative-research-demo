(function () {
  ...
  var dataDetails = [
    ...
    ['Option contract selection', 'Matched near-at-the-money pair', 'The signal pairs one call and one put at the same strike and expiration. The selected pair is approximately 25-35 calendar days from expiration and within 5% of spot; each leg receives its own Black-Scholes implied volatility and delta.'],
  ...
  var settings = [
    ['Starting capital', '$100,000', 'Sets the NAV base assumptionfor the sizing budgets and portfolio buying power.'],
  ...
  var controls = [
    ...
    ['02', 'Overfit control & Walk-forward', 'The model choice was made using 2024 development data, with 2025-2026 preserved as holdout period. Models are refit using only prior observations and evaluated on following days; rolling windows reduce coefficients overfitting and help the forecast adapt to different volatility regimes.'],
    ['03', 'Position sizing', 'The formula takes the most restrictive of stress loss, future hedge capacity, and current buying-power constraints. This prevents an attractive signal from becoming an unbounded premium exposure and preserve space for diversification.'],
      ...
      <main class="case-view" id="long-straddle">
        ...
        <section class="case-section case-section-paper" id="performance">
          <div class="content-width">
            ...
            <div class="case-metrics">
              ...
              <div class="case-metric"><div class="case-metric-label">Win rate</div><div class="case-metric-value">53.6%</div></div>
        ...
        <section class="case-section case-section-paper" id="model">
          <div class="content-width">
            ...
            <div class="case-paper-block"><div class="case-paper-block-header"><div><div class="case-paper-label">Research design</div><h3>Choose the forecast before the holdout evaluation test</h3></div></div><p class="case-paper-copy">A set of commonly-used volatility-forecast candidates were compared on a common 2024 development sample. The displayed economic evaluation remains strictly holdout period from 2025-01-01 through 2026-09-01. The pooled rolling HAR-RV + IV specification was selected because it combines the lowest error and strong linear association among the declared candidates.</p></div>
        ...
        <section class="case-section case-section-paper" id="findings">
          <div class="content-width">
            ...
            <div class="case-detail-grid case-attribution-grid"><article class="case-detail-card"><div class="case-detail-label">Gross option book</div><h3>+$112.1k</h3><p>Combined option-mark change before option execution costs; broken down into the four Greek effects below.</p></article><article class="case-detail-card"><div class="case-detail-label">Stock hedge</div><h3>-$52.7k</h3><p>Cash result of daily delta rebalancing; it offsets the option book&apos;s +$52.7k first-order delta effect.</p></article><article class="case-detail-card"><div class="case-detail-label">Execution</div><h3>-$14.1k</h3><p>$12.1k of option costs plus $2.0k of stock-hedge costs under the modeled execution assumptions.</p></article><article class="case-detail-card"><div class="case-detail-label">Net result</div><h3>+$45.3k</h3><p>Gross option book plus stock hedge less execution costs.</p></article></div>
