...
var dailySnapshots = [
  ...
  var controls = [
    ...
    ['02', 'Overfit control & Walk-forward', 'The model choice was made using 2024 development data, with 2025-2026 preserved as a holdout period. Models are refit using only prior observations and evaluated on following days; walk-forward refitting reduces coefficient overfitting and helps the forecast adapt to different volatility regimes.'],
  ...
  window.initLongStraddle = function () {
    ...
    var mode = 'equity';
    var eventMarkers = [
      { date: '2025-04-03', label: "Apr 3rd '25" },
      { date: '2025-05-12', label: "May 12th '25" },
      { date: '2026-01-27', label: "Jan 27th '26" }
    ];
